...
export const Heart = () => {
  ...
  return (
    <>
      {[controlPoints1, controlPoints2].map(([v0, v1, v2, v3], index) => (
...
export const Circle = ({ centerX = 0, centerY = 0, radius = 5 }: { centerX?: number; centerY?: number; radius?: number } = {}) => {
