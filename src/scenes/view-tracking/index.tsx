...
export default function ViewTracking() {
  useEffect(() => {
    ...
    const off = addEffect((t: number) => lenis.raf(t))
    return () => {
      off()
      lenis.destroy()
    }
  ...
  return (
    <div className="absolute inset-0 overflow-auto bg-[#f0f0f0]">
      <div className="vt-text">
        ...
        <View className="vt-view vt-translateX">
        ...
        <View className="vt-view vt-scale">
  ...
  return (
    <a
      ...
      onPointerMove={(e) => {
        ...
        const y = e.nativeEvent.offsetY - target.offsetTop - 100
